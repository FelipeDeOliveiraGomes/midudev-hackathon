...
export const generateInfojobsAuthUrl = (scope: string, destination: string) => {
    return `https://www.infojobs.net/api/oauth/user-authorize/index.xhtml?scope=${scope}&client_id=${INFOJOBS_CLIENT_ID}d&redirect_uri=${APP_HOST}/${destination}&response_type=code`;
};
